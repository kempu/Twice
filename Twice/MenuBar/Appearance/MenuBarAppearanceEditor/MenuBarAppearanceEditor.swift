...
struct MenuBarAppearanceEditor: View {
    ...
    private var mainForm: some View {
        TwiceForm(padding: mainFormPadding) {
            TwiceSection {
                isDynamicToggle
            }
    ...
    private var cannotEdit: some View {
        Text("Twice cannot edit the appearance of automatically hidden menu bars")
            .font(.title3)
...
private struct UnlabeledPartialEditor: View {
    ...
    private var tintPicker: some View {
        TwiceLabeledContent("Tint") {
            HStack {
                TwicePicker("Tint", selection: $configuration.tintKind) {
    ...
    private var borderColor: some View {
        if configuration.hasBorder {
            TwiceLabeledContent("Border Color") {
                CustomColorPicker(
