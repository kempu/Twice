...
final class MenuBarManager: ObservableObject {
    ...
    /// The panel that contains the Twice Bar interface.
    let twiceBarPanel: TwiceBarPanel
    ...
    init(appState: AppState) {
        self.twiceBarPanel = TwiceBarPanel(appState: appState)
