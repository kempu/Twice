...
extension Defaults {
    enum Key: String {
        ...
        case showTwiceIcon = "ShowTwiceIcon"
        case twiceIcon = "TwiceIcon"
        case customTwiceIconIsTemplate = "CustomTwiceIconIsTemplate"
        case useTwiceBar = "UseTwiceBar"
        ...
        // MARK: Twice Bar Settings

        case twiceBarLocation = "TwiceBarLocation"
        case twiceBarPinnedLocation = "TwiceBarPinnedLocation"
